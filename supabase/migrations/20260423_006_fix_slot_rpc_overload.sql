-- Fix overloaded RPC definitions that can cause unstable PostgREST resolution.
-- Keep one canonical create_host_availability_slot function signature.

drop function if exists public.create_host_availability_slot(
  uuid,
  timestamptz,
  timestamptz,
  integer,
...
create function public.create_host_availability_slot(
